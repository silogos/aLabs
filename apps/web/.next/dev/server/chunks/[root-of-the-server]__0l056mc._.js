...
"[project]/apps/web/src/app/api/[[...route]]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
/** Catch-all that mounts the Hono API in-process under /api.
 *  Same origin as the UI — cookies flow, no proxy needed. */ var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/api/src/index.ts [app-route] (ecmascript) <locals>");
;
const runtime = "nodejs";
const dynamic = "force-dynamic";
const handler = (req)=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiApp"].fetch(req);
;
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/core/src/index.ts [app-route] (ecmascript)");
...
function seed() {
    ...
    const seedUser = (name, email)=>{
        const u = {
            id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["uuidv7"])(),
            name,
            email,
            image: null,
            emailVerified: true,
    ...
    /* ---------------- Roles ---------------- */ for (const r of [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SYSTEM_WORKSPACE_ROLES"],
        ...__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SYSTEM_PROJECT_ROLES"]
    ]){
        const role = {
            id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["uuidv7"])(),
            organizationId: null,
 ...
 *  `apiApp` is the same routes under /api for the Next.js catch-all route. */ var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$app$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/api/src/app.ts [app-route] (ecmascript)");
;
;
const apiApp = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$app$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["app"].basePath("/api");
}),
...
class ApiError extends Error {
    ...
    get httpStatus() {
        return this.status ?? __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ERROR_STATUS"][this.code];
    }
    toJSON() {
        return {
            error: {
...
agreement.post("/agreements", (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("agreement:create"), async (c)=>{
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["agreementCreate"]);
    const a = {
        id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["uuidv7"])(),
        projectId: pidOf(c),
        title: input.title,
...
agreement.patch("/agreements/:id", (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("agreement:update"), async (c)=>{
    const a = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$db$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["store"].agreements.find((x)=>x.id === c.req.param("id") && x.projectId === pidOf(c) && !x.deletedAt);
    if (!a) throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notFound"])();
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["agreementUpdate"]);
    if (input.status && input.status !== a.status) {
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["canTransition"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AGREEMENT_TRANSITIONS"], a.status, input.status)) throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["conflict"])("Invalid status transition");
    }
...
/* ---------------- email + password ---------------- */ auth.post("/register", async (c)=>{
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerInput"]);
...
auth.post("/login", async (c)=>{
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["loginInput"]);
...
/* ---------------- forgot / reset password ---------------- */ auth.post("/forgot-password", async (c)=>{
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["forgotPasswordInput"]);
    const user = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$db$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["store"].users.find((u)=>u.email.toLowerCase() === input.email.toLowerCase());
...
auth.post("/reset-password", async (c)=>{
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resetPasswordInput"]);
...
documents.post("/documents/spaces", (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("document:create"), async (c)=>{
    const pid = pidOf(c);
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["spaceCreate"]);
    const s = {
        id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["uuidv7"])(),
        projectId: pid,
        name: input.name,
...
documents.get("/documents/pages", (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("document:view"), (c)=>{
    const q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseQuery"])(c.req.query(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["paginationQuery"]);
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$responses$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["paginated"])(c, (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["paginate"])(rows, q));
});
documents.post("/documents/pages", (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("document:create"), async (c)=>{
    const user = c.get("user");
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pageCreate"]);
...
documents.patch("/documents/pages/:id", (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("document:update"), async (c)=>{
    const user = c.get("user");
    const p = findPage(c);
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pageUpdate"]);
    ...
    if (input.content) {
        const parsed = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["contentSchema"].safeParse(input.content);
...
documents.post("/documents/files", (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("file:upload"), async (c)=>{
    ...
    const id = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["uuidv7"])();
    const fname = `${id}${ext}`;
...
meeting.post("/meetings", (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("meeting:create"), async (c)=>{
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["meetingCreate"]);
    const m = {
        id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["uuidv7"])(),
        projectId: pidOf(c),
        title: input.title,
...
meeting.patch("/meetings/:id", (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("meeting:update"), async (c)=>{
    const m = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$db$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["store"].meetings.find((x)=>x.id === c.req.param("id") && x.projectId === pidOf(c) && !x.deletedAt);
    if (!m) throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notFound"])();
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["meetingUpdate"]);
    if (input.status && input.status !== m.status) {
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["canTransition"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MEETING_TRANSITIONS"], m.status, input.status)) throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["conflict"])("Invalid status transition");
    }
...
organization.post("/", async (c)=>{
    const user = c.get("user");
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["organizationCreate"]);
...
organization.patch("/:organizationId", __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$tenant$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["orgContext"], (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("organization:update"), async (c)=>{
    const org = currentOrg(c);
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["organizationUpdate"]);
...
organization.patch("/:organizationId/members/:memberId", __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$tenant$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["orgContext"], (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("member:update"), async (c)=>{
    ...
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["memberUpdate"]);
 ...
 * invitation. Accept requires the invitee to already have an account. */ organization.post("/:organizationId/invitations", __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$tenant$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["orgContext"], (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("member:create"), async (c)=>{
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["invitationInput"]);
    const org = currentOrg(c);
...
organization.get("/:organizationId/invitations", __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$tenant$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["orgContext"], (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("member:view"), (c)=>{
    const q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseQuery"])(c.req.query(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["paginationQuery"]);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$responses$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["paginated"])(c, (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["paginate"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$db$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["store"].invitations.filter((i)=>i.organizationId === currentOrg(c).id), q));
});
...
organization.patch("/:organizationId/invitations/:invitationId", __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$tenant$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["orgContext"], (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("member:create"), async (c)=>{
    ...
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["invitationAction"]);
...
planning.post("/planning/iterations", (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("planning:manage"), async (c)=>{
    const pid = pidOf(c);
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["iterationCreate"]);
    const it = {
        id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["uuidv7"])(),
        projectId: pid,
        name: input.name,
...
planning.patch("/planning/iterations/:id", (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("planning:manage"), async (c)=>{
    ...
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["iterationUpdate"]);
    if (input.status && input.status !== it.status) {
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["canTransition"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ITERATION_TRANSITIONS"], it.status, input.status)) throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["conflict"])(`Cannot transition iteration from ${it.status} to ${input.status}`);
    }
...
planning.post("/planning/milestones", (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("planning:manage"), async (c)=>{
    const pid = pidOf(c);
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["milestoneCreate"]);
    const m = {
        id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["uuidv7"])(),
        projectId: pid,
        name: input.name,
...
planning.patch("/planning/milestones/:id", (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("planning:manage"), async (c)=>{
    ...
    if (!m) throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notFound"])();
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["milestoneUpdate"]);
    if (input.status && input.status !== m.status) {
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["canTransition"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MILESTONE_TRANSITIONS"], m.status, input.status)) throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["conflict"])(`Cannot transition milestone from ${m.status} to ${input.status}`);
    }
    Object.assign(m, input, {
        updatedAt: new Date().toISOString()
    });
...
project.post("/", __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$tenant$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["orgContext"], (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("project:create"), async (c)=>{
    const user = c.get("user");
    const orgId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$tenant$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["currentTenant"])(c).organizationId;
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["projectCreate"]);
    ...
    if (org?.type === "personal") {
        ...
        if (active >= __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PERSONAL_PROJECT_LIMIT"]) throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["badRequest"])(`Personal workspaces are limited to ${__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PERSONAL_PROJECT_LIMIT"]} active projects`);
    }
    const proj = {
        id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["uuidv7"])(),
    ...
    for (const s of __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_TASK_STATUSES"]){
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$db$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["store"].taskStatuses.push({
            id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["uuidv7"])(),
            projectId: proj.id,
            name: s.name,
    ...
    for (const name of __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_TASK_TYPES"]){
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$db$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["store"].taskTypes.push({
            id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["uuidv7"])(),
            projectId: proj.id,
            name
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$responses$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["created"])(c, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["projectSchema"].parse(proj));
});
...
projectMembers.post("/members", __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$tenant$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["projectContext"], (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("project:manage-members"), async (c)=>{
    ...
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["projectMemberAdd"]);
...
projectMembers.patch("/members/:memberId", __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$tenant$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["projectContext"], (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("project:manage-members"), async (c)=>{
    ...
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["projectMemberUpdate"]);
    if (input.roleName) {
...
project.patch("/:projectId", __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$tenant$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["projectContext"], (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("project:update"), async (c)=>{
    const proj = currentProject(c);
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["projectUpdate"]);
    if (input.status && input.status !== proj.status) {
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["canTransition"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PROJECT_TRANSITIONS"], proj.status, input.status)) throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["conflict"])(`Cannot transition project from ${proj.status} to ${input.status}`);
    }
...
reporting.get("/reporting/dashboard", (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("reporting:view"), (c)=>{
    const pid = pidOf(c);
    const project = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["projectSchema"].parse(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$db$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["store"].projects.find((p)=>p.id === pid));
...
const taskListQuery = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["paginationQuery"].extend({
...
task.get("/tasks", (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("task:view"), (c)=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$responses$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["paginated"])(c, (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["paginate"])(rows.map((r)=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["taskSchema"].parse(r)), q));
});
task.post("/tasks", (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("task:create"), async (c)=>{
    const pid = projectIdOf(c);
    const user = c.get("user");
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["taskCreate"]);
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$responses$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["created"])(c, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["taskSchema"].parse(created_));
});
...
task.patch("/tasks/:id", (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])("task:update"), async (c)=>{
    const t = findTask(c);
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["taskUpdate"]);
...
users.patch("/me", async (c)=>{
    const user = c.get("user");
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userUpdate"]);
...
users.post("/me/recents", async (c)=>{
    const user = c.get("user");
    const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$api$2f$src$2f$lib$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBody"])(await c.req.json(), __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["recentTouch"]);
...
"[project]/packages/core/src/index.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "VERSION",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["VERSION"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/core/src/index.ts [app-route] (ecmascript) <locals>");
(()=>{
...
(()=>{
    const e = new Error("Cannot find module './uuid.js'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './content.js'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './schemas/index.js'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './schemas/common.js'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './constants/permissions.js'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './constants/roles.js'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './constants/plans.js'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './constants/state-machines.js'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0l056mc._.js.map