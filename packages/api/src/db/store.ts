 ...
 * business modules: documents (spaces/pages/files), meetings, agreements,
 * notifications, activity. Tasks and planning are in Postgres
 * (db/task-repo.ts, db/planning-repo.ts).
 *
